...
const int leftLED = 4;                           // Left turn signal LEDs
const int rightLED = 3;                         // Right turn signal LEDs
const int reverseLight = 2;                    // Backup LEDs
const int brakes = 5;                            // Brake LEDs

unsigned long LHCU_ID = 0x30C;           // Lights and Horns signal ID
unsigned long Brake_ID = 0x1F4;           // Brake signal ID

byte LightsAndHornSignals[8];             // Recieve buffer for turn signals, headlights and horns from SCU
byte Brake[8];                                   // Recieve buffer for brake signal from DCU
