...
byte BrakeSend[8];                              //Brake message buffer
byte RelaySend[8];                              //Secondary relay control message buffer

//CAN receiving message buffers
byte VelocityBuf[8];                            //Velocity buffer from motor controller

//Initialize pins
const int brakes = 2;                           //INPUT: Brake lever switch
...
//Reading inputs
  ...
  }else BrakeSend[0] = false;                       //Set brake state to off
